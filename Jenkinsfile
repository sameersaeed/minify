            ...
            steps {
                sshagent(credentials: ['github-ssh-key']) {
                    sh '''
                        ...
                        cd k8s
                        curl -sL https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize%2Fv5.4.1/kustomize_v5.4.1_linux_arm64.tar.gz | tar xz
                        ...
                        git remote set-url origin git@github.com:sameersaeed/minify.git
